...
<div class="container">
    <div class="text-section">
        ...
        <form action="processar_evento.php" method="post" class="form-evento" enctype="multipart/form-data">
            ...
            <label for="loc_evento">Localização do Evento:</label>
            <input type="text" id="loc_evento" name="loc_evento" required>
            ...
            <label for="criador_evento">Criador do Evento:</label>
            <input type="text" id="criador_evento" name="criador_evento" required>
